...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "네. 한양대학교 재학생과 휴학생 모두 지원할 수 있습니다.",
  },
  {
    question: "선발 절차는 어떻게 되나요?",
    answer: "별도의 면접 없이 지원서 서류 심사만으로 선발합니다. 최종 결과는 9월 7일에 개별 안내드립니다.",
  },
  {
    question: "금요일 저녁 스터디에 매번 참석해야 하나요?",
    answer: "네. 정기 스터디는 금요일 저녁에 진행되며 매번 참석하는 것을 원칙으로 합니다. 정확한 시간과 장소는 대관 확정 후 안내드립니다.",
  },
  {
    question: "회비가 있나요?",
    answer: "회비는 없습니다. 별도의 비용 부담 없이 활동에 참여할 수 있습니다.",
  },
